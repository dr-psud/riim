...
add_para("Tahun 1: Rp750.000.000; Tahun 2: Rp800.000.000; Tahun 3: Rp650.000.000; Total: Rp2.200.000.000 (dana pendamping Rp0).", justify=False)
...
add_para("Tahun 1 — Fondasi fenotip & data omik: standar fenotip; koleksi sampel ≥200 ekor; genotyping tahap I; metabolom subset; draft manuskrip 1; draft KI.")
...
add_para("Lokasi: Kabupaten Temanggung, Jawa Tengah. Mitra: DKPPP Temanggung dan komunitas DSL/peternak. Target sampel genomik minimal 200 ekor (ideal 240–300), seimbang Teropong : non-Teropong, mempertimbangkan jenis kelamin dan kelas umur. Subset metabolomik 60–100 ekor terpilih berdasarkan kontras fenotip/performa, distandardisasi sampling.")
...
add_para("Tahun 1: 1 publikasi minimal Q3 under review; draft paten sederhana/KI; database fenotip ≥200 ekor + biobank; draft standar fenotip galur.")
...
add_para("Tahun 1 Rp750.000.000 (Personil 180 jt; Non-personil 540 jt; Tidak langsung 30 jt).")
add_para("Tahun 2 Rp800.000.000 (Personil 180 jt; Non-personil 580 jt; Tidak langsung 40 jt).")
add_para("Tahun 3 Rp650.000.000 (Personil 150 jt; Non-personil 470 jt; Tidak langsung 30 jt).")
add_para("Total usulan Rp2.200.000.000. RAB detail per item dilampirkan pada lembar RAB resmi sistem Pendanaan Risnov, termasuk pemisahan harga pokok dan pajak sesuai status PKP/Non-PKP institusi.")
